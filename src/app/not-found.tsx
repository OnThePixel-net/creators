...
export const metadata: Metadata = {
  title: "404 - Seite nicht gefunden | OnThePixel.net",
  description: "Die gesuchte Seite konnte nicht gefunden werden. Kehre zur Startseite zurück oder entdecke unsere Creator.",
};
